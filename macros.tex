...
\autor{JOÃO FERNANDO RANGEL GUIMARÃES}
\titulo{Título do projeto: Subtítulo}
...
\orientador[Orientador][Prof. Dr.]{Rodrigo}[Varejão Andreão]{Instituto Federal do Espírito Santo}
\coorientador[Coorientadora][Prof. Dr.]{Leandro}[Bueno]{Instituto Federal do Espírito Santo}
